...
//                .csrf().disable() // FIXME!
    ...
    protected UserDetailsService userDetailsService() {
        UserDetails u = User.builder()
                ...
                .authorities(AppUserRole.USER.grantedAuthoritySet())
                .build();
        ...
        UserDetails traineeAdmin = User.builder()
                ...
                .authorities(AppUserRole.TRAINEE_ADMIN.grantedAuthoritySet())
                .build();
        ...
        UserDetails a = User.builder()
                ...
                .authorities(AppUserRole.ADMIN.grantedAuthoritySet())
                .build();
